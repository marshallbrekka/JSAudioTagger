...
var audio = lib.util.extendNamespace("audio.mp4");
 ...
 */
function Mp4AtomIdentifier(field) {
    this.fieldName = field[0];
    this.description = field[1];
}
...
for(var t in types) {
    if(types.hasOwnProperty(t)) {
        Mp4AtomIdentifier[t] = types[t];
    }
}
   

Mp4AtomIdentifier.prototype.getFieldName = function(){
    return this.fieldName;
}

Mp4AtomIdentifier.prototype.getDescription = function() {
    return this.description;
}

audio.Mp4AtomIdentifier = Mp4AtomIdentifier;
